...
We are developing a trading system designed from the ground up for high-performance execution, and we are also building an ecosystem of quantitative trading algorithms which run on this system. In the future, alongside trading our proprietary strategies, we aim to offer execution services that optimize liquidity, enhance order flow, and improve price discovery. Our algorithms will be designed to:
